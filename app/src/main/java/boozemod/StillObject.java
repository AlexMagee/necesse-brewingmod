...
public class StillObject extends GameObject implements SettlementWorkstationObject {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/still");
    }
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new StillObjectEntity(level, x, y);
    }
    ...
    public ListGameTooltips getItemTooltips(InventoryItem item, PlayerMob perspective) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "stilltip"));
        return tooltips;
    }
